...
//        event(new LoginEvent($user));
    ...
    {
        $this->resetRaspUser();
        $url = 'http://10.110.34.127:8080/reset_uid';
//        $url = 'http://192.168.2.179:8080/reset_uid';
        $data = array('type' => 'reset_uid');
        $options = array(
            'http' => array(
    ...
    public function turn_on()
    {
        ...
        $url = 'http://10.110.34.127:8080/turn_on';
//        $url = 'http://192.168.2.179:8080/turn_on';
    ...
    {
        //create request to Raspberry Pi with 192.168.2.179:8001
        $url = 'http://10.110.34.127:8080/turn_off';
